...
const Hero = () => {
  return (
    ...
    >
      <div
        className={`flex flex-col items-center md:items-start md:justify-center md:h-screen ${styles.paddingX} w-full m-auto mt-[5rem] md:mt-0`}
      >
      ...
      <ComMe className="w-full  min-w-[40rem]" />
    </section>
  );
};
